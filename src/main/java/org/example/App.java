...
//        RambunctiousRecitation rambunctiousRecitation = new RambunctiousRecitation("input.txt");
//
//        System.out.println("* Part1: " + rambunctiousRecitation.getPart1(2020));
//        System.out.println("* Part2: " + rambunctiousRecitation.getPart2(30000000));

        System.out.println("Day 16:");
        TicketTranslation ticketTranslation = new TicketTranslation("input.txt");
        ...
        System.out.println("* Part1: " + conwayCubes.getPart1(6));
        System.out.println("* Part2: " + conwayCubes.getPart2());

        System.out.println("Day 18:");
        OperationOrder operationOrder = new OperationOrder("input.txt");
